...
\begin{proof}
This is (implied by) Lemma 3.36 of \cite{myself}.
\end{proof}
...
\begin{enumerate}[label=(G\arabic*)]
    ...
    \item $P(\mathfrak{T})^{(\alpha)} = \{p \in [\mathcal{L}_{\mathfrak{T}}]^{< \omega} : \exists \Sigma \ (``\Sigma \ \Gamma_{\mathfrak{T}}^{(\alpha)} (\mathcal{L}_{\mathfrak{T}}, \mathfrak{A}^*_{\mathfrak{T}})\text{-certifies } p")\}$ by straightforward induction incorporating an argument similar to that which proved Lemma 3.35 of \cite{myself}, 
\end{enumerate}
...
\begin{proof}
This is Theorem 5.59 of \cite{myself}.
\end{proof}
